...
declare module 'worker_threads' {
     ...
     * takes its place.
     *
     * The returned `MessagePort` is an objеской операции должен иметь тип \"any\", \"number\", \"bigint\" или тип перечисления.",
  ...
  "The_types_returned_by_0_are_incompatible_between_these_types_2201": "Типы, возвращаемые \"{0}\", несовместимы между этими типами.",
  "The_variable_declaration_of_a_for_in_statement_canno